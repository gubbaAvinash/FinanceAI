...
Partial.button6Tap = function ($event, widget) {
    Partial.Widgets.button7.show = true
    Partial.Widgets.button6.show = false
    Partial.Widgets.label11_1.show = true
    Partial.Widgets.label10_1.caption = "Here's your generated long response"
};
Partial.button7Tap = function ($event, widget) {
    Partial.Widgets.button7.show = false
    Partial.Widgets.button6.show = true
    Partial.Widgets.label11_1.show = false
    Partial.Widgets.label10_1.caption = "View long response"
};
